...
notificationsRouter.post("/", requireAuth, requirePermission("safety.manage", "fleet.manage"), async (req, res, next) => {
  try {
...
notificationsRouter.post("/:notification_id/read", requireAuth, async (req, res, next) => {
  try {
